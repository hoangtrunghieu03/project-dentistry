        ...
        <>
          <Col span={18} style={{ marginTop: "1rem" }} xs={24} sm={24} md={18}>
            <div className="all-comment-info">
              <div style={{ display: "flex" }}>
                {comment.isAdmin && comment.isAdmin ? (
                  <div className="all-comment-info-name admin">
                    <img alt="" src="https://cellphones.com.vn/skin/frontend/default/cpsdesktop/images/media/logo.png"></img>
                  </div>
                ) : (
          ...
          {repCmt.status === true && repCmt.key === comment._id ? (
            ...
            >
              ...
              >
                <textarea
                  placeholder="Xin mời để lại câu hỏi, Cellphone sẽ trả lời trong 1h từ 8h - 22h mỗi ngày."
                  rows={10}
                  cols={3}
                  vaule={repValue}
      ...
      {/* <Col span={18}>
          ...
          </Col> */}
          {
            ...
            <div className="comment-area" style={{display: 'flex', alignItems:'center'}}>
              <textarea placeholder='Xin mời để lại câu hỏi, Cellphone sẽ trả lời sớm nhất từ 8h - 22h mỗi ngày.' rows={10} cols={3}></textarea>
            </div>
            <div className="comment-send">
